...
public class DragonsteelItem extends LegendaModElements.ModElement {
	@ObjectHolder("legenda:dragonsteel")
	public static final Item block = null;
	public DragonsteelItem(LegendaModElements instance) {
		super(instance, 33);
	}
