...
package net.mcreator.legenda.keybind;
...
public class TestKeyBinding extends LegendaModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public TestKeyBinding(LegendaModElements instance) {
		super(instance, 49);
	...
	public void initElements() {
		keys = new KeyBinding("key.legenda.test", GLFW.GLFW_KEY_0, "key.categories.misc");
