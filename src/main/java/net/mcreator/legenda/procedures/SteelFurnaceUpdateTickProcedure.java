...
import net.mcreator.legenda.item.SteelingotItem;
import net.mcreator.legenda.item.RawLavasteelItem;
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("x") == null) {
			if (!dependencies.containsKey("x"))
				LegendaMod.LOGGER.warn("Failed to load dependency x for procedure SteelFurnaceUpdateTick!");
			return;
		}
		if (dependencies.get("y") == null) {
			if (!dependencies.containsKey("y"))
				LegendaMod.LOGGER.warn("Failed to load dependency y for procedure SteelFurnaceUpdateTick!");
			return;
		}
		if (dependencies.get("z") == null) {
			if (!dependencies.containsKey("z"))
				LegendaMod.LOGGER.warn("Failed to load dependency z for procedure SteelFurnaceUpdateTick!");
			return;
		}
		...
		if ((((new Object() {
			...
			public ItemStack getItemStack(BlockPos pos, int sltid) {
				...
				}.getItemStack(new BlockPos((int) x, (int) y, (int) z), (int) (2))).getItem() == new ItemStack(RawLavasteelItem.block, (int) (1))
						.getItem()) && ((new Object() {
							public int getAmount(IWorld world, BlockPos pos, int sltid) {
								AtomicInteger _retval = new AtomicInteger(0);
								TileEntity _ent = world.getTileEntity(pos);
			...
			if (((new Object() {
				...
				if (((new Object() {
				...
				}.getValue(world, new BlockPos((int) x, (int) y, (int) z), "recipe")) == 1)) {
					{
						...
						if (_ent != null) {
							final int _sltid = (int) (2);
							final ItemStack _setstack = new ItemStack(RawLavasteelItem.block, (int) (1));
							_setstack.setCount((int) ((new Object() {
								public int getAmount(IWorld world, BlockPos pos, int sltid) {
									AtomicInteger _retval = new AtomicInteger(0);
									TileEntity _ent = world.getTileEntity(pos);
